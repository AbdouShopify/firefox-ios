...
extension ActivityStreamPanel {
    ...
    enum Section: Int {
        ...
        var eventSource: ASSourceField {
            switch self {
            case .Highlights: return ASSourceField.highlights
            case .TopSites: return ASSourceField.topSites
            }
        }
...
extension ActivityStreamPanel {
    ...
    func hideFromTopSites(site: Site) {
        let siteURL = site.tileURL
    ...
    private func presentContextMenu(site: Site, eventInfo: ASInfo, siteImage: UIImage?, siteBGColor: UIColor?) {
        ...
        switch eventInfo.source {
            case .highlights: actions.append(dismissHighlightAction)
